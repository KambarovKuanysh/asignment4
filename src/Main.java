...
class Main {
    public static void main(String[] args) {
        ...
        // Task 6
        System.out.println("Task 6: Power. Test data: (2, 10).");
        System.out.println("2 to the power of 10: " + Task_6.Power(2, 10));
        System.out.println(divider);

        // Task 7
        System.out.println("Task 7: reverseArray. Test data: 4, {1, 4, 6, 2}. This task needs user input to function.");
        ...
        // Task 8
        System.out.println("Task 8: checkIfNum. Test data: 123456, 123a12.");
        ...
        // Task 9
        System.out.println("Task 9: countBinaryCombo. Test data: (2,1); (7,3).");
        System.out.print(Task_9.countBinaryCombo(1, 2) + " ");
        System.out.println(Task_9.countBinaryCombo(3,7));
        System.out.println(divider);

        //Task 10
        System.out.println("Task 10: findGCD. Test data: (32, 48); (10, 7).");
